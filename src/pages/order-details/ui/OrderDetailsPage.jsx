...
export function OrderDetailsPage() {
  ...
  if (!order) {
    return (
      <p className="py-24 text-center text-muted">Order not found.</p>
    );
  }
    ...
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <div className="mb-6 rounded-xl border border-line">
        {order.items.map((item, idx) => (
          <div
            key={idx}
            className="flex items-center justify-between border-b border-line p-4 last:border-0"
          >
            <div>
      ...
      <div className="mb-6 rounded-xl border border-line p-5">
