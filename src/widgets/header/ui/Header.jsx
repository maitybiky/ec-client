...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-20 px-3 pt-3 sm:px-4">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 rounded-full border border-line bg-surface/80 px-4 py-2.5 shadow-soft backdrop-blur-md">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            className="flex h-9 w-9 items-center justify-center rounded-full bg-surface-2 md:hidden"
      ...
      {menuOpen && (
        <div className="mx-auto mt-2 max-w-6xl rounded-3xl border border-line bg-surface p-4 shadow-lift md:hidden">
